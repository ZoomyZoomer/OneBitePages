...
function MainArticleSet() {
  ...
  useEffect(() => {
    fetch('https://one-bite-pages.vercel.app:4000/post').then(response => {
  ...
  useEffect(() => {
    fetch('https://one-bite-pages.vercel.app:4000/programming2').then(response => {
      response.json().then(posts => {
  ...
  useEffect(() => {
    fetch('https://one-bite-pages.vercel.app:4000/mentalhealth').then(response => {
      response.json().then(posts => {
...
function SubArticleSet() {
  ...
  useEffect(() => {
    fetch('https://one-bite-pages.vercel.app:4000/education2').then(response => {
      response.json().then(posts => {
  ...
  useEffect(() => {
    fetch('https://one-bite-pages.vercel.app:4000/sports').then(response => {
      response.json().then(posts => {
...
function ImageArticleSet(){
  ...
  useEffect(() => {
    fetch('https://one-bite-pages.vercel.app:4000/cooking2').then(response => {
      response.json().then(posts => {
...
function Trends() {
  ...
  useEffect(() => {
    fetch('https://one-bite-pages.vercel.app:4000/programming').then(response => {
      response.json().then(posts => {
        setProgrammingPosts(posts);
      });
    });
  ...
  useEffect(() => {
    fetch('https://one-bite-pages.vercel.app:4000/education').then(response => {
      response.json().then(posts => {
        setEducationPosts(posts);
      });
    });
  ...
  useEffect(() => {
    fetch('https://one-bite-pages.vercel.app:4000/cooking').then(response => {
      response.json().then(posts => {
        setCookingPosts(posts);
      });
    });
