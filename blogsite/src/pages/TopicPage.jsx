  ...
  useEffect(() => {
    const getPosts = async () => {
      try {
        ...
        switch (routeTopic) {
            case 'programming':
              response = await fetch('https://one-bite-pages.vercel.app/programming2');
              break;
            case 'mentalHealth':
              response = await fetch('https://one-bite-pages.vercel.app/mentalHealth2');
              break;
            case 'cooking':
              response = await fetch('https://one-bite-pages.vercel.app/cooking2');
              break;
            case 'sports':
              response = await fetch('https://one-bite-pages.vercel.app/sports2');
              break;
            case 'education':
              response = await fetch('https://one-bite-pages.vercel.app/education2');
              break;
            default:
